...
# ═══════════════════════════════════════════════════════════════
#  CONFIG
#  - Set DRY_RUN = True to test without an API key (logs to terminal)
#  - Set DRY_RUN = False and fill in RIDESCAN_API_KEY when key arrives
# ═══════════════════════════════════════════════════════════════

RIDESCAN_API_URL    = 'https://api.ridescan.ai/v1/telemetry'
RIDESCAN_API_KEY    = 'YOUR_API_KEY_HERE'
ROBOT_ID            = 'my_bot'
